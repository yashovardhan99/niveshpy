...
class TestListAccounts:
    ...
    def test_list_all_accounts_no_filter(
    ...
    def test_list_accounts_with_offset(
        self, account_service: AccountService, sample_accounts
    ):
    ...
    def test_list_accounts_offset_beyond_total(
        self, account_service: AccountService, sample_accounts
    ):
    ...
    def test_list_accounts_with_query_filter(
        self, account_service: AccountService, sample_accounts
    ):
    ...
    def test_list_accounts_query_no_matches(
        self, account_service: AccountService, sample_accounts
    ):
    ...
    def test_list_accounts_invalid_limit_zero(
        self, account_service: AccountService, sample_accounts
    ):
